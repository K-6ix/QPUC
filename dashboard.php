...
<aside class="sidebar" id="sidebar">
  ...
  <div class="sidebar-profile">
    <div class="profile-mini" onclick="document.querySelector('.profile-card').scrollIntoView({behavior:'smooth'})">
      <div class="avatar-sm">
        <img src="https://api.dicebear.com/7.x/adventurer/svg?seed=hestim" alt="avatar" onerror="this.style.display='none'">
        K
      </div>
      <div class="profile-mini-info">
        <div class="profile-mini-name">Kepler</div>
        <div class="profile-mini-rank">⭐ Légendaire</div>
      </div>
  ...
  <div class="content">
    ...
    <div class="welcome-banner">
      <div class="welcome-text">
        ...
        <div class="welcome-name" id="display-name">Kepler</div>
        <div class="welcome-status">Statut : <span>En ligne</span> · Saison 4 en cours</div>
      </div>
      <div class="rank-badge">
        <div class="rank-badge-label">Rang Global</div>
        <div class="rank-badge-value">#12</div>
        <div class="rank-badge-sub">Top 1% mondial</div>
      </div>
    </div>
    ...
    <div class="stats-row">
      <div class="stat-card">
        ...
        <div class="stat-value" id="cnt-games">0</div>
        <div class="stat-change up">↑ +12 cette semaine</div>
      </div>
      <div class="stat-card">
        <div class="stat-icon">🏆</div>
        <div class="stat-label">Victoires</div>
        <div class="stat-value" id="cnt-wins">0</div>
        <div class="stat-change up">↑ 68.4% winrate</div>
      </div>
      <div class="stat-card">
        <div class="stat-icon">⚡</div>
        <div class="stat-label">KDA Moyen</div>
        <div class="stat-value" id="cnt-kda">0.0</div>
        <div class="stat-change up">↑ +0.3 ce mois</div>
      </div>
      <div class="stat-card">
        <div class="stat-icon">💎</div>
        <div class="stat-label">Points ELO</div>
        <div class="stat-value" id="cnt-elo">0</div>
        <div class="stat-change down">↓ −45 hier</div>
      </div>
    </div>
      ...
      <div style="display:flex;flex-direction:column;gap:20px;">
        ...
        <div class="panel">
          ...
          <div class="panel-body" style="display:grid;grid-template-columns:1fr 1fr;gap:24px;align-items:center;">
            ...
            <div>
              <div class="prog-row">
                <div class="prog-label-row"><span class="prog-name">Attaque</span><span class="prog-val">87%</span></div>
                <div class="prog-track"><div class="prog-fill" style="width:0%" data-w="87"></div></div>
              </div>
              <div class="prog-row">
                <div class="prog-label-row"><span class="prog-name">Défense</span><span class="prog-val">72%</span></div>
                <div class="prog-track"><div class="prog-fill" style="width:0%" data-w="72"></div></div>
              </div>
              <div class="prog-row">
                <div class="prog-label-row"><span class="prog-name">Vitesse</span><span class="prog-val">91%</span></div>
                <div class="prog-track"><div class="prog-fill" style="width:0%" data-w="91"></div></div>
              </div>
              <div class="prog-row">
                <div class="prog-label-row"><span class="prog-name">Stratégie</span><span class="prog-val">78%</span></div>
                <div class="prog-track"><div class="prog-fill" style="width:0%" data-w="78"></div></div>
              </div>
              <div class="prog-row">
                <div class="prog-label-row"><span class="prog-name">Précision</span><span class="prog-val">84%</span></div>
                <div class="prog-track"><div class="prog-fill" style="width:0%" data-w="84"></div></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="panel">
          <div class="panel-header">
            <div class="panel-title">Historique des Matchs</div>
            <span style="font-size:0.68rem;color:var(--g500);letter-spacing:1px;cursor:pointer;">Voir tout →</span>
          </div>
          <div class="matches">
            <div class="match-row">
              <div class="match-result win">V</div>
              <div class="match-info">
                <div class="match-vs">vs ShadowWolf99</div>
                <div class="match-map">ARENA NORD · Ranked</div>
              </div>
              <div class="match-score">3–1</div>
              <div class="match-kda">K/D/A<br><b>14/3/8</b></div>
            </div>
            <div class="match-row">
              <div class="match-result win">V</div>
              <div class="match-info">
                <div class="match-vs">vs IronBlade_X</div>
                <div class="match-map">CITADELLE · Ranked</div>
              </div>
              <div class="match-score">2–0</div>
              <div class="match-kda">K/D/A<br><b>22/5/11</b></div>
            </div>
            <div class="match-row">
              <div class="match-result loss">D</div>
              <div class="match-info">
                <div class="match-vs">vs NightHunter</div>
                <div class="match-map">VOLCAN · Ranked</div>
              </div>
              <div class="match-score">1–3</div>
              <div class="match-kda">K/D/A<br><b>8/12/4</b></div>
            </div>
            <div class="match-row">
              <div class="match-result draw">N</div>
              <div class="match-info">
                <div class="match-vs">vs StormRider</div>
                <div class="match-map">DÉSERT · Normal</div>
              </div>
              <div class="match-score">2–2</div>
              <div class="match-kda">K/D/A<br><b>11/9/7</b></div>
            </div>
            <div class="match-row">
              <div class="match-result win">V</div>
              <div class="match-info">
                <div class="match-vs">vs CrimsonAce</div>
                <div class="match-map">TEMPLE · Ranked</div>
              </div>
              <div class="match-score">3–0</div>
              <div class="match-kda">K/D/A<br><b>19/2/14</b></div>
            </div>
          </div>
        </div>
      ...
      <div class="profile-panel">
        ...
        <div class="profile-card">
          ...
          <div class="profile-avatar-wrap">
            <label for="file-input" class="avatar-lg" title="Changer la photo">
              ...
              <div class="avatar-inner-lg">
                <img id="preview" src="https://api.dicebear.com/7.x/adventurer/svg?seed=hestim" alt="avatar">
              </div>
          ...
          <div class="profile-card-body">
            <div class="profile-name" id="show-name">Kepler</div>
            <div class="profile-email" id="show-email">kepler@hestim.ma</div>
            <hr class="profile-divider">
            <form onsubmit="saveProfile(event)">
              <div class="form-field">
                <label class="form-label">Nom d'utilisateur</label>
                <input class="form-input" type="text" id="inp-username" value="Kepler" autocomplete="username">
              </div>
              <div class="form-field">
                <label class="form-label">Adresse e-mail</label>
                <input class="form-input" type="email" id="inp-email" value="kepler@hestim.ma" autocomplete="email">
              </div>
        ...
        <div class="panel">
          ...
          <div class="leader-row">
            ...
            <div class="leader-avatar">NK</div>
            <div class="leader-name">NightKing</div>
            <div class="leader-pts">9,840</div>
          </div>
          <div class="leader-row">
            <div class="leader-rank silver">2</div>
            <div class="leader-avatar">SX</div>
            <div class="leader-name">ShadowX</div>
            <div class="leader-pts">9,210</div>
          </div>
          <div class="leader-row">
            <div class="leader-rank bronze">3</div>
            <div class="leader-avatar">IB</div>
            <div class="leader-name">IronBlade</div>
            <div class="leader-pts">8,975</div>
          </div>
          <div class="leader-row">
            <div class="leader-rank other">4</div>
            <div class="leader-avatar">SR</div>
            <div class="leader-name">StormRider</div>
            <div class="leader-pts">8,540</div>
          </div>
          <div class="leader-row" style="background:rgba(212,175,55,0.04);border:1px solid var(--border2);border-radius:var(--r);margin:4px 10px;">
            <div class="leader-rank gold">12</div>
            <div class="leader-avatar" style="background:linear-gradient(135deg,var(--g700),var(--g400));color:#000;">K</div>
            <div class="leader-name leader-self">Kepler <span style="color:var(--text3);font-size:0.65rem;">(vous)</span></div>
            <div class="leader-pts">7,320</div>
          </div>
        </div>
...
function animCount(el, target, duration, decimals=0, suffix='') {
  ...
  let t=setInterval(()=>{
    ...
    el.textContent = decimals>0 ? start.toFixed(decimals)+suffix : Math.floor(start)+suffix;
  },16);
}
setTimeout(()=>{
  animCount(document.getElementById('cnt-games'), 248, 1200);
  animCount(document.getElementById('cnt-wins'), 169, 1200);
  animCount(document.getElementById('cnt-kda'), 4.7, 1200, 1);
  animCount(document.getElementById('cnt-elo'), 7320, 1400);
},300);
...
function saveProfile(e){
  e.preventDefault();
  const name = document.getElementById('inp-username').value.trim() || 'Kepler';
  ...
  btn.style.background = 'linear-gradient(120deg,#1a3a1a,#2d6a2d)';
  btn.style.color = '#4caf78';
  setTimeout(()=>{ btn.textContent='Enregistrer'; btn.style.background=''; btn.style.color=''; },2000);
}
...
const perfData = {
  week: {
    ...
    wins:  [3,5,2,7,4,8,6],
    elo:   [7100,7180,7140,7280,7240,7360,7320]
  },
  month: {
    labels:['S1','S2','S3','S4'],
    wins:  [18,24,21,28],
    elo:   [6800,7050,7200,7320]
  },
  season: {
    labels:['Jan','Fev','Mar','Avr','Mai'],
    wins:  [45,62,58,71,67],
    elo:   [5500,6100,6600,7100,7320]
  }
};
...
new Chart(radarCtx,{
  type:'radar',
  data:{
    labels:['Attaque','Défense','Vitesse','Stratégie','Précision','Endurance'],
    datasets:[{
      label:'Kepler',
      data:[87,72,91,78,84,80],
