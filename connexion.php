...
<style>
        ...
        *{
        ...
        input:-webkit-autofill {
            -webkit-box-shadow: 0 0 0px 1000px #000000 inset !important; /* fond noir */
            -webkit-text-fill-color: #fcf6ba !important; /* texte doré clair */
        ...
        @media (max-width: 950px) {
            ...
            /* Cache les animations d’arrière-plan sur mobile */
            .bg-animate,
            .bg-animate2 {
                display: none;
            }
        ...
        /* Très petits écrans (moins de 500px) */
...
<?php endif; ?>
    ...
    <div class="wrapper">
        ...
        <!-- login -->
            <div class="form-box login animation">
                <h2 style="--i:0; --j:18;" class="animation">Connection</h2>
                ...
                <form action="login.php" method="POST">
                    ...
                    <div class="input-box animation" style="--i:2; --j:20;">
                        ...
                        <!-- <input type="checkbox" onclick="psd.type =this.checked ? 'text' : 'password' " > -->
                    </div>
                    <button id="login-btn" type="submit" class="btn animation" style="--i:3; --j:21;">Login</button>
            ...
            <div class="info-texte login">
                ...
                <p style="--i:3; --j:21;" class="animation">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nam cum, voluptatem sequi temporibus minima, </p>
            </div>
        ...
        <div class="form-box nouveau">
            ...
            <form action="signup.php" method="POST">
                ...
                <button type="submit" class="btn animation" style="--i:24; --j:4;">Debuter</button>
        ...
        <div class="info-texte nouveau animation" >
            ...
            <p class="animation"style="--i:17 ; --j:1;">Lorem ipsJum dolor sit, amet consectetur adipisicing elit. Nam cum, voluptatem sequi temporibus minima, </p>
        </div>
    </div>
    ...
    <script>
        ...
        nouveauLink.onclick = () => {
            ...
            console.log(" transition vers creation active");
            
        }
        connexionLink.onclick = () => {
            wrapper.classList.remove("active");
            console.log(" transition vers login active");
